    ...
    <>
      ...
      <div className='flex flex-col items-center'>
        ...
        <div style={{ width: "330px", boxShadow: "rgb(0 0 0 / 10%) 0px 0px 10px" }}
          ...
          <h3 className='text-gray-700 font-bold'>Регистрация аккаунта</h3>
          ...
          <form className='z-20' onSubmit={submitHandler}>
            ...
            <input className='ease-in duration-200 hover:bg-gray-200 focus:border-blue-400 focus:bg-white w-full mb-3 outline-none rounded-md border-gray-300 border-2 px-3 py-2' placeholder='Введите имя' required />
